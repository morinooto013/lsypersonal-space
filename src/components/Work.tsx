        ...
        <div className="mb-20">
          ...
          <div className="card-glass rounded-2xl p-6 mb-5">
            <div className="flex gap-3 overflow-x-auto pb-1 mb-5" style={{ scrollSnapType: 'x mandatory' }}>
              <div className="rounded-xl overflow-y-auto bg-white/5 flex-none w-[140px] sm:flex-1" style={{ maxHeight: '420px', scrollSnapAlign: 'start' }}>
        ...
        <div>
          ...
          <div className="card-glass rounded-2xl p-6">
            <div className="flex gap-3 overflow-x-auto pb-1" style={{ scrollSnapType: 'x mandatory' }}>
              <div className="rounded-xl overflow-hidden bg-white/5 flex-none w-[120px] sm:flex-1" style={{ scrollSnapAlign: 'start' }}>
