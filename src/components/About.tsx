      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-8 items-start">
          ...
          <div className="shrink-0 flex justify-center sm:justify-start">
            <div className="relative rounded-2xl overflow-hidden w-36 sm:w-44"
              style={{
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="card-glass rounded-2xl p-7">
              <h3 className="text-foreground text-sm font-medium mb-5">教育背景</h3>
            ...
            {/* Profile */}
            <div className="card-glass rounded-2xl p-7 space-y-3 text-sm text-muted-foreground leading-relaxed">
            ...
            {/* Skills */}
            <div className="card-glass rounded-2xl p-7">
              <h3 className="text-foreground text-sm font-medium mb-5">个人技能</h3>
